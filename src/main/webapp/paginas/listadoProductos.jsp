                ...
                <div >
                    <div class="container-fluid">
                        ...
                        <div>
                            ...
                            <div>
                                <a href="#" class="btn btn-primary mt-4 mb-4" data-bs-toggle="modal" data-bs-target="#agregarProductoModal">
                                    <i class="fas fa-plus"></i>Crear nuevo producto</a>
                            </div>
                            <table class='table'>
                                <thead>
                                    <tr>
                                ...
                                <c:forEach items="${productos}" var="pro">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="${pageContext.request.contextPath}/productos?accion=eliminar&idProducto=${pro.id_producto}"
                                                      method="POST">
                                            ...
                                            <td>
                                                <a href="${pageContext.request.contextPath}/productos?accion=modificar&idProducto=${pro.id_producto}" class="btn btn-primary">Modificar</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </c:forEach>
