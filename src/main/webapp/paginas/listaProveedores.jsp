...
<jsp:include page="/WEB-INF/comunes/head.jsp"> 
    <jsp:param name="title" value="Lista Proveedores" />
</jsp:include>
                ...
                <div >
                    <div class="container-fluid">
                        ...
                        <div>
                            ...
                            <div>
                                <a href="#" class="btn btn-primary mt-4 mb-4" data-bs-toggle="modal" data-bs-target="#agregarProveedoresModal">
                                    <i class="fas fa-plus"></i>Agregar Proveedor</a>
                            </div>
                            <table class='table'>
                                <thead>
                                    <tr>
                                ...
                                <c:forEach items="${proveedores}" var="pvd">
                                    <tbody>
                                        <tr>
                                            <td scope="row">${pvd.id_proveedor}</td>
                                            <td>${pvd.nombre}</td>
                                            <td>${pvd.telefono}</td>
                                            <td>
